...
HD_PWD='D:/Vivado/Project/mfcc/project_1/project_1.runs/mult_dct_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_dct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_dct.tcl
