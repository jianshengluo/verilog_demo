...
HD_PWD='D:/Vivado/Project/mfcc/project_1/project_1.runs/float2fixed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float2fixed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float2fixed.tcl
