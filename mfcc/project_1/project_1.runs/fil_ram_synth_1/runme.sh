...
HD_PWD='D:/Vivado/Project/mfcc/project_1/project_1.runs/fil_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fil_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fil_ram.tcl
