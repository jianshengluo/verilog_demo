...
HD_PWD='D:/Vivado/Project/mfcc/project_1/project_1.runs/ln_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ln_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ln_ip.tcl
