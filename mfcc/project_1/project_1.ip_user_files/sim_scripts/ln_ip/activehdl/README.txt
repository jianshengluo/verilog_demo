...
#
# Generated by export_simulation on Thu Apr 25 17:06:53 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './ln_ip.sh' script.
...
./ln_ip.sh -noclean_files

For more information on the script, please type './ln_ip.sh -help'.
