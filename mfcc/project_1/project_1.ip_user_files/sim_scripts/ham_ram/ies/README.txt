...
#
# Generated by export_simulation on Thu Apr 25 17:07:13 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './ham_ram.sh' script.

./ham_ram.sh -reset_run
...
./ham_ram.sh -noclean_files

For more information on the script, please type './ham_ram.sh -help'.
