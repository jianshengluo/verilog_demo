...
#
# Generated by export_simulation on Thu Apr 25 17:06:41 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './mult_dct.sh' script.

./mult_dct.sh -reset_run
...
./mult_dct.sh -noclean_files

For more information on the script, please type './mult_dct.sh -help'.
