...
#
# Generated by export_simulation on Thu Apr 25 17:06:49 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './float2fixed.sh' script.

./float2fixed.sh -reset_run
...
./float2fixed.sh -noclean_files

For more information on the script, please type './float2fixed.sh -help'.
